...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        //wp_register_script('boostrap', get_template_directory_uri() . '/js/scripts.js', array('jquery'), '1.0.0'); // Boostrap
        wp_enqueue_script( 'boostrap', get_stylesheet_directory_uri() . '/js/bootstrap.js', array( 'jquery' ) );
        wp_enqueue_script('boostrap'); // Enqueue it!
...
function html5blank_styles()
{
    ...
    wp_register_style('boostrap', get_template_directory_uri() . '/css/bootstrap.min.css', array(), '1.0', 'all');
...
function register_html5_menu()
{
    register_nav_menus(array( // Using array to specify more menus if needed
        ...
        'header-menu2' => __('Header Menu123', 'html5blank'), // Main2 Navigation
